;(function (module) {
	...
	_filter = function(pred) {
		return function(arr) {
			var selected = arr.reduce(function(acc, curr) {
				return pred.call(this, curr)? acc.concat(curr): acc;
			}.bind(this), []);
	...
	_reduce = function(fn, acc) {
		...
		return function(arr) {
			...
			var reduced = arr.reduce(function(acc, curr) {
				return fn.call(this, curr, acc);
			}.bind(this), acc? acc : arr[0]);
