;(function (module) {
	...
	_error = {
		...
		'functionParam': function(funcName) {
			return 'expected param[1] of "' 
			+ funcName + '" to be of type "Function"';
		}
	},
	...
	Subscriber.prototype = {
		...
		'reduceRight': function(fn, acc) {
			...
			if(!_truthy(fn).fun()) {
				throw new TypeError(
					_error.functionParam('reduceRight')
				);
			}
