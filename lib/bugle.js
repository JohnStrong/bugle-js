...
;(function (module) {
	...
	_pipe = function() {
		...
		// change this horrible recreation each time later
		return {

			'map': function(fn) {
				self._pipeline_.push(_map(fn));
				return this;
			},
		
			'filter': function(pred) {
				self._pipeline_.push(_filter(pred));
				return this;
			},

			'flatMap': function(fn) {
				self._pipeline_.push(_flatMap(fn));
				return this;
			},

			'flatten': function() {
				self._pipeline_.push(_flatten);
				return this;
			},
			
			'receive': function(fn) {
				self._pipeline_.push(_receive(fn));
			}
		};
	},
